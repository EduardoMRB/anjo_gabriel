...
namespace Anjo\EventoBundle\Controller;
...
use Anjo\EventoBundle\Entity\Evento;
use Anjo\EventoBundle\Form\EventoType;
...
class EventoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AnjoEventoBundle:Evento')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AnjoEventoBundle:Evento')->find($id);
     ...
     * @Method("POST")
     * @Template("AnjoEventoBundle:Evento:new.html.twig")
     */
     ...
     * @Method("POST")
     * @Template("AnjoEventoBundle:Evento:edit.html.twig")
     */
